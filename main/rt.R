...
df_rt <- import('C:/Users/hanna/OneDrive - London School of Hygiene and Tropical Medicine/3_summer/analysis/rt.csv')
  
df_rt[,2:6] <- round(df_rt[,2:6], 1)

export(df_rt, 'C:/Users/hanna/OneDrive - London School of Hygiene and Tropical Medicine/3_summer/analysis/rounded_rt.csv')
