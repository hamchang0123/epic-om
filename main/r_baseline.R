...
#---Day 19 betas
parameters['b_aa_d19'] = (sub_weight_Ia + pre_cl_weight_Ia) *parameters['u_a'] * (parameters['c_aa_c2.2_max'] * parameters['intv_c4.4_a']) * parameters['k'] / parameters['popn_a']
parameters['b_ay_d19'] = (sub_weight_Iy + pre_cl_weight_Iy) *parameters['u_a'] * (parameters['c_ay'] * parameters['intv_c4.4_y']) * parameters['k'] / parameters['popn_a']
parameters['b_yy_d19'] = (sub_weight_Iy + pre_cl_weight_Iy) *parameters['u_y'] * (parameters['intv_c1.1'] * parameters['c_yy']* parameters['intv_c4.4_y']) * parameters['k'] / parameters['popn_y']
parameters['b_ya_d19'] = (sub_weight_Ia + pre_cl_weight_Ia) *parameters['u_y'] * (parameters['c_ya'] * parameters['intv_c4.4_a']) * parameters['k'] / parameters['popn_y']
...
#---Day 0-21 betas
parameters['b_aa_d0_21'] = (sub_weight_Ia + pre_cl_weight_Ia) *parameters['u_a'] * (parameters['c_aa_c2.2'] * parameters['intv_c4.4_a']) * parameters['k'] / parameters['popn_a']
parameters['b_ay_d0_21'] = (sub_weight_Iy + pre_cl_weight_Iy) *parameters['u_a'] * (parameters['c_ay'] * parameters['intv_c4.4_y']) * parameters['k'] / parameters['popn_a']
parameters['b_yy_d0_21'] = (sub_weight_Iy + pre_cl_weight_Iy) *parameters['u_y'] * (parameters['intv_c1.1'] * parameters['c_yy']* parameters['intv_c4.4_y']) * parameters['k'] / parameters['popn_y']
parameters['b_ya_d0_21'] = (sub_weight_Ia + pre_cl_weight_Ia) *parameters['u_y'] * (parameters['c_ya'] * parameters['intv_c4.4_a']) * parameters['k'] / parameters['popn_y']
...
#---Day 22-43 betas
parameters['b_aa_d22_43'] = (sub_weight_Ia + pre_cl_weight_Ia) *parameters['u_a'] * (parameters['c_aa_c2.2'] * parameters['intv_c4.4_a']) * parameters['k'] / parameters['popn_a']
parameters['b_ay_d22_43'] = (sub_weight_Iy + pre_cl_weight_Iy) *parameters['u_a'] * (parameters['c_ay'] * parameters['intv_c4.4_y']) * parameters['k'] / parameters['popn_a']
parameters['b_yy_d22_43'] = (sub_weight_Iy + pre_cl_weight_Iy) *parameters['u_y'] * (parameters['c_yy']* parameters['intv_c4.4_y']) * parameters['k'] / parameters['popn_y']
parameters['b_ya_d22_43'] = (sub_weight_Ia + pre_cl_weight_Ia) *parameters['u_y'] * (parameters['c_ya'] * parameters['intv_c4.4_a']) * parameters['k'] / parameters['popn_y']
...
#---Day 92-165 betas
parameters['b_aa_d_92_165'] = parameters['b_aa']
parameters['b_ay_d_92_165'] = parameters['b_ay']
parameters['b_yy_d_92_165'] = parameters['b_yy']
parameters['b_ya_d_92_165'] = parameters['b_ya']
...
export(r_param, 'C:/Users/hanna/OneDrive - London School of Hygiene and Tropical Medicine/3_summer/output/r_baseline.csv')
