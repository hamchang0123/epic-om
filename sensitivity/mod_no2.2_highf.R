...
## Remove c2.2
mod_no_c2.2_highf <- function(time, state, parameters) {
...
p2.2_highf <- ggplot() + 
  geom_line(data = output2_no_c2.2_highf, aes(x=time, y=Dt_per_m, colour='without'))+
